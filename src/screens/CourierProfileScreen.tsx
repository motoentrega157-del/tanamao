...
export default function CourierProfileScreen({ onLogout, onNavigate, onOpenNotifications, unreadCount }: { onLogout: () => void, onNavigate: (screen: Screen) => void, onOpenNotifications: () => void, unreadCount: number }) {
